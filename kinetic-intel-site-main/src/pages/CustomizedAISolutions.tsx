      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div {...fadeUp} className="max-w-3xl">
            <span className="text-primary text-sm font-semibold tracking-widest uppercase mb-3 block">Customized AI Solutions</span>
            <h1 className="text-5xl sm:text-6xl font-heading font-bold mb-6">
              Bespoke <span className="text-gradient">AI Solutions</span>
            </h1>
        ...
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Experience the power of custom-built AI solutions designed for your specific needs.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              From concept to deployment, we build AI solutions that deliver real results.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
...
export default CustomizedAISolutions;