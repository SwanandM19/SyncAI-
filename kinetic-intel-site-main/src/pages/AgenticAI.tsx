      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div {...fadeUp} className="max-w-3xl">
            <span className="text-primary text-sm font-semibold tracking-widest uppercase mb-3 block">Agentic AI</span>
        ...
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Unlock the potential of autonomous AI agents for your business operations.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Building intelligent autonomous systems that work around the clock.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
